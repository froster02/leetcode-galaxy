    ...
    return (
        <div style={{
            ...
            <a
                ...
                onMouseEnter={e => { e.currentTarget.style.color = '#fff'; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.4)'; e.currentTarget.style.background = 'rgba(255,255,255,0.13)'; }}
                onMouseLeave={e => { e.currentTarget.style.color = 'rgba(255,255,255,0.85)'; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.2)'; e.currentTarget.style.background = 'rgba(255,255,255,0.07)'; }}
            >
            ...
            <div style={{
                ...
                <span>made with</span>
                <svg width="12" height="12" viewBox="0 0 24 24" fill="#ef4444" style={{ flexShrink: 0, filter: 'drop-shadow(0 0 4px rgba(239,68,68,0.7))' }}>
